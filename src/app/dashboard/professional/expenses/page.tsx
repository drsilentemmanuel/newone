                                    ...
                                    <div className="grid gap-4 py-4">
                                        ...
                                        <div className="grid grid-cols-4 items-start gap-4">
                                            ...
                                            <div className="col-span-3">
                                                <Label htmlFor="receipt-upload-prof" className="flex flex-col items-center justify-center w-full h-24 border-2 border-dashed rounded-lg cursor-pointer bg-muted hover:bg-muted/80">
                                                    ...
                                                    <Input id="receipt-upload-prof" type="file" className="hidden" />
                                                </Label>
                                            </div>
                                        </div>
                                    </div>
