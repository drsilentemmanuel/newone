...
const faqs = [
  {
    question: "Does using Trust Stamp cost money?",
    answer: "Trust Stamp offers both free and premium features. Basic profile creation and searching is free for all users. Advanced features like detailed credit checks, e-signing, and premium support may require a subscription or a one-time fee.",
  },
  {
  ...
  },
  {
    ...
    answer: "When you market a property through Trust Stamp, it is typically syndicated to our partner sites within 24-48 hours. However, the exact time can vary depending on the third-party platform.",
  },
  {
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <HelpOptionCard
            ...
            description="Our Trust Stamp-based team is here to help! Start a chat or send us an email."
