        ...
        <Card>
            <CardHeader className="text-center">
                <div className="flex justify-center mb-4">
                    <UniversalAccess className="h-16 w-16 text-primary" />
                </div>
                <CardTitle className="font-headline !text-4xl">Accessibility Statement</CardTitle>
                <p className="text-muted-foreground pt-2">We are committed to ensuring digital accessibility for people with disabilities. We are continually improving the user experience for everyone and applying the relevant accessibility standards.</p>
            </CardHeader>
