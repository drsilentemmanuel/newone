    ...
    <div className="container mx-auto max-w-4xl py-12 md:py-16">
      <div className="space-y-6">
        ...
        <div className="space-y-4 text-muted-foreground">
          ...
          <p>We do not share your personal information with companies, organizations, or individuals outside of Trust Stamp except in the following cases: with your consent, with domain administrators, for external processing, for legal reasons.</p>
